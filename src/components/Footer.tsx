...
function Footer() {
  return (
      <footer className='bg-black text-gray-400 py-12 botton-0 left-0 w-ful'>
        ...
        <p>Dive into our comprehensive coding courses and transform your development journey today. Whether you are a beginner or looking to refine your programming skills, join us to unlock your true coding potential.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p className='text-white'><a href="/.mail@gmail.com">mazhar.iqbal223@gmail.com</a></p>
        <p className='text-white'>Phone:<span className='hover:text-white'>03056957022</span></p>
